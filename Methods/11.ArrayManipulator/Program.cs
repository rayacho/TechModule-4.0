                ...
                switch (command[0])
                {
                    ...
                    case "max":
                        ...
                        switch (maxEvenOrOdd)
                        {
                            ...
                            case "odd":
                                int m = MaxOdd(input)[0];
                                int anotherMaxIndex = MaxOdd(input)[1];
                                ...
                                {
                                    Console.WriteLine(anotherMaxIndex);
                                }
                    ...
                    case "min":
                        ...
                        switch (minEvenOrOdd)
                        {
                            ...
                            case "odd":
                                int m = MinOdd(input)[0];
                                int anotherMinIndex = MinOdd(input)[1];
                                ...
                                {
                                    Console.WriteLine(anotherMinIndex);
                                }
